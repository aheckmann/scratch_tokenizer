...
// TODO - recover the original merges from the gpt-4 tokenizer
// https://www.fast.ai/posts/2025-10-16-karpathy-tokenizers.html#step-3-load-gpt-4-merges
// Skipped b/c the task doesn't seem to teach much anything new - just copy some tiktoken code.
